...
import type { StationData, StationResponses, StationErrors, TrainsForStationData, TrainsForStationResponses, TrainsForStationErrors, StopsForStationData, StopsForStationResponses, StopsForStationErrors, StationsData, StationsResponses, StationsErrors, TrainData, TrainResponses, TrainErrors, TrainsData, TrainsResponses, TrainsErrors, TrainByIdData, TrainByIdResponses, TrainByIdErrors, MessagesForDateAndCodeData, MessagesForDateAndCodeResponses, MessagesForDateAndCodeErrors, MessagesForTrainData, MessagesForTrainResponses, MessagesForTrainErrors, StatusCodesData, StatusCodesResponses, StatusCodesErrors } from './types.gen';
...
export const stopsForStation = <ThrowOnError extends boolean = false>(options: Options<StopsForStationData, ThrowOnError>) => {
    return (options.client ?? client).get<StopsForStationResponses, StopsForStationErrors, ThrowOnError>({
...
export const statusCodes = <ThrowOnError extends boolean = false>(options?: Options<StatusCodesData, ThrowOnError>) => {
    return (options?.client ?? client).get<StatusCodesResponses, StatusCodesErrors, ThrowOnError>({
        url: '/status_codes/',
        ...options
    });
};
